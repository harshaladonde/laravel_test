    ...
    public function store(Request $request)
    {
        ...
        try {
            $validatedData = $request->validate([
                ...
                'department' => 'required',
                'hobbies' => 'required',
                'profile' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048', // Max file size of 2MB
            ]);
           ...
           $request->profile->move(public_path('profiles'), $imageName);
            ...
            $employee->hobbies =  $validatedData['hobbies']; 
            $employee->profile = $imageName; // Save the profile picture path
